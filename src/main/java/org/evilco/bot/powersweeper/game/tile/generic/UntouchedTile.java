 ...
 */
public class UntouchedTile extends AbstractTile {

	/**
	 * Constructs a new UntouchedTile instance.
	 * @param location The tile location.
	 * @param template The tile template.
	 * @param parser The tile parser.
	 */
	public UntouchedTile (TileLocation location, ITileTemplate template, ITileParser parser) {
